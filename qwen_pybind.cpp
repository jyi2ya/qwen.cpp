...
PYBIND11_MODULE(_C, m) {
    ...
    py::class_<GenerationConfig>(m, "GenerationConfig")
        .def(
                py::init<int, int, bool, int, float, float, float, int>(),
                "max_length"_a = 2048,
                "max_context_length"_a = 512,
                "do_sample"_a = true,
                "top_k"_a = 0,
                "top_p"_a = 0.5,
                "temperature"_a = 0.95,
    ...
    py::class_<QwenTokenizer>(m, "QwenTokenizer")
        .def("encode_history", &qwen::QwenTokenizer::encode_history)
        .def("encode", &qwen::QwenTokenizer::encode)
        .def("decode", &qwen::QwenTokenizer::decode);
