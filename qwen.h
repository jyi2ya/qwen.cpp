...
class QwenAttention {
  public:
    ...
    auto forward(ModelContext *ctx, ggml_tensor *hidden_states, int n_past) const -> ggml_tensor *;
...
class QwenModel {
  public:
    ...
    auto forward(ModelContext *ctx, ggml_tensor *input_ids, int n_past) const -> ggml_tensor *;
